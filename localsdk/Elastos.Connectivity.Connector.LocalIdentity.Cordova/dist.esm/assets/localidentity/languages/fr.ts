export const fr = {
  ...
  'identitysetup': {
    ...
    'slide3-msg': 'Dans l\'avenir, pour mieux gérer cette identité ou l\'utiliser dans d\'autres applications qui supportent les DIDs, vous pourrez l\'exporter vers un portefeuille d\'identité tiers tel qu\'Elastos Essentials.',
  ...
  'credaccess': {
    ...
    'message': 'Cette application demande un accès à certaines informations de votre profile. Comme vous utilisez une identité temporaire, des informations par défaut vont être retournées pour le moment. Plus tard, vous pourrez gérer votre identité en détail via une portefeuille d\'identités tel qu\'Elastos Essentials.',
  },
  ...
  'manageidentity': {
    ...
    'intro3': 'Nous vous recommandons d\'exporter cette identité vers un portefeuille d\'identité externe tel qu\'Elastos Essentials (application tierce que vous devez d\'abord installer).',

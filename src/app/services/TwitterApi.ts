export class TwitterApi {
  ...
  public static CLIENT_ID: string = "RDdwOVotcHZhQjFpTzlyWlJNTm46MTpjaQ"
  ...
  public static AUTH: string = "https://twitter.com/i/oauth2/authorize?response_type=code&client_id=RDdwOVotcHZhQjFpTzlyWlJNTm46MTpjaQ&redirect_uri=https://feeds.trinity-feeds.app/login-from-twitter&scope=tweet.read%20tweet.write%20users.read%20offline.access&state=state&code_challenge=challenge&code_challenge_method=plain"

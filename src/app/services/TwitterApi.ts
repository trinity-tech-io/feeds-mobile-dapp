export class TwitterApi {
  ...
  public static REDIRECT_URI: string = "https://www.baidu.com"
  public static CODE_VERIFIER: string = "challenge"

  public static AUTH: string = "https://twitter.com/i/oauth2/authorize?response_type=code&client_id=MloxZFZUd21FWEJ1VHBnMkd3RHA6MTpjaQ&redirect_uri=https://www.baidu.com&scope=tweet.read%20tweet.write%20users.read%20follows.read+follows.write%20offline.access&state=state&code_challenge=challenge&code_challenge_method=plain"

export class TwitterApi {
  ...
  public static REDIRECT_URI: string = "https://feeds.feedsnetwork.io/login-from-twitter"
  ...
  public static AUTH: string = "https://twitter.com/i/oauth2/authorize?response_type=code&client_id=Q2tUNTJzakF0S1RFY0otRVc4WEE6MTpjaQ&redirect_uri=https://feeds.feedsnetwork.io/login-from-twitter&scope=tweet.read%20tweet.write%20users.read%20offline.access&state=state&code_challenge=challenge&code_challenge_method=plain"
